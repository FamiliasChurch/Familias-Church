...
import { Search, Filter, Phone, Mail, Calendar, UserCheck } from "lucide-react";
...
export default function MembersList() {
  ...
  return (
    <div className="min-h-screen bg-background p-6 pt-32 font-body text-white">
      <div className="container mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full glass p-4 pl-12 rounded-2xl outline-none focus:border-destaque/50"
        ...
        <div className="glass rounded-[2.5rem] overflow-hidden border border-white/5 overflow-x-auto">
          ...
          {membrosFiltrados.length === 0 && (
            <div className="p-20 text-center text-white/20 uppercase tracking-[0.5em] text-xs">
